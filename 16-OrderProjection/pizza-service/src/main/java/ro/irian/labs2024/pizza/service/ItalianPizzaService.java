...
public class ItalianPizzaService implements PizzaService {
    ...
    public List<PizzaVO> getDataPizzaVOs(){
        return pizzaJpaRepository.findAllPizzaVOs();
    }

    public List<PizzaVO> getPizzaVOsByName(String name){
        return pizzaJpaRepository.findAllPizzaVOsByName("%" + name + "%");
    }

    public List<PizzaProjection> getPizzaProjections(){
        return pizzaJpaRepository.findAllProjectedBy();
    }

    public List<PizzaProjection> getPizzaProjectionsByName(String name){
        return pizzaJpaRepository.findAllByNameLikeIgnoreCase("%" + name + "%");
    }

    public Page<PizzaProjection> getPizzaProjectionsPaged(Pageable pageable){
        return pizzaJpaRepository.findAllProjectedBy(pageable);
    }
}
