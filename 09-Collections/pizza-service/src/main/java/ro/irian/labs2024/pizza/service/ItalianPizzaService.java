...
import ro.irian.labs2024.pizza.domain.Ingredient;
import ro.irian.labs2024.pizza.domain.IngredientRepository;
...
public class ItalianPizzaService implements PizzaService {
    ...
    public void savePizzas(){
        ...
        Ingredient ingredient = new Ingredient(null, "tomato", 5.0);
        Ingredient ingredient1 = new Ingredient(null, "mozzarella", 6.0);
        Ingredient ingredient2 = new Ingredient(null, "salami", 8.0);
...
/*
        List<Ingredient> prosciuttoIngredients = List.of(ingredientRepository.findByName("tomato"), ingredientRepository.findByName("mozzarella"));
*/
